...
MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            sql = "UPDATE nhaxuatban SET  Tennxb=N'" + txtTenNXB5.Text.Trim().ToString() + "',Diachinxb=N'" + txtDiaChi5.Text.Trim().ToString() + "',sdtnxb=N'" + maskedDienthoai.Text.Trim().ToString() + "',Emailnxb=N'" + txtEmail5.Text.Trim().ToString() + "'where Manxb=N'" + txtMaNXB5.Text.Trim() + "'";
            Functions.RunSql(sql);
            Load_DataGridView();
            ResetValues();
            nxbBoQua.Enabled = false;
...
MessageBoxIcon.Information);
    ...
    txtDiaChi5.Text = nxbDataGrid.CurrentRow.Cells["Diachinxb"].Value.ToString();
    maskedDienthoai.Text = nxbDataGrid.CurrentRow.Cells["sdtnxb"].Value.ToString();
    txtMail5.Text = nxbDataGrid.CurrentRow.Cells["Emailnxb"].Value.ToString();
    nxbSua.Enabled = true;
    nxbXoa.Enabled = true;
    nxbBoQua.Enabled = true;
...
MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                sql = "DELETE from NHAXUATBAN WHERE MaNXB=N'" + txtMaNXB5.Text + "'";
        ...
        private void maskedDienthoai_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
