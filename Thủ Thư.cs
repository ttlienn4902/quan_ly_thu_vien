...
namespace quan_ly_thu_vien
{
    public partial class Thủ_Thư : Form
    {
        ...
        private void Load_DataGridView()
        {
            ...
            dataGridViewthuthu.Columns[3].HeaderText = "Điện thoại CĐ";
            dataGridViewthuthu.Columns[4].HeaderText = "Điện thoại DD";
...
MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                sql = "DELETE FROM thuthu WHERE Mathuthu=N'" + txtMathuthu.Text + "'";
...
MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            sql = "UPDATE thuthu SET  Tenthuthu=N'" + txtTenThuThu6.Text.Trim().ToString()
                  + "',Diachithuthu=N'" + txtDiaChi6.Text.Trim().ToString() + "',SDTCDTHUTHU='" +
